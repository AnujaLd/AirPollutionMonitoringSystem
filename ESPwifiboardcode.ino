...
String apiKey = "WYFH2Y4YMPBG0MNV"; // Enter your Write API key from ThingSpeak
const char *ssid = "test_foodcity_bot_wifi2";     // replace with your wifi ssid and wpa2 key
const char *pass = "11111111111";
